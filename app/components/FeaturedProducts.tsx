...
export default function ProductCard({
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900 shadow-xl transition-all duration-300 hover:scale-[1.02]">
      ...
      <div className="p-5">
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <button
            ...
            className="h-14 w-14 rounded-full bg-yellow-400 text-3xl font-black text-black transition hover:scale-110 active:scale-95"
          >
            +
          </button>
        </div>
